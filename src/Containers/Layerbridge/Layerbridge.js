                    ...
                    <Row className="mt40">
                        <Col lg={6}>
                            ...
                            <table className="es-transaction striped bordered hover">
                                <tr>
                                    <td className="noborder" width="150"><p className="explr-text-black">ESN to ETH</p></td>
                                    <td className="noborder"><p className="explr-purple-text">Last Block Number on Plasma Smart <br/>Contract: 110783 (+39 blocks pending)</p>
                                    </td>
                                </tr>
                                <tr>
                        ...
                        <Col lg={6}>
                            <table className="es-transaction striped bordered hover">
                                <tr>
                                    <td className="noborder" width="150"><p className="explr-text-black">ESN to ETH</p></td>
                                    <td className="noborder"><p className="explr-purple-text">Live block number of Rinkeby ETH (Layer 1): 6871773<br/>
                                                                 Block number confirmed on ESN Reverse Plasma Contract: 6869710(2061 pending)</p>
                                 </td>
                                </tr>
                                <tr>
