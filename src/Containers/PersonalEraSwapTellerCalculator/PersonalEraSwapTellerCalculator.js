                          ...
                          <div class="form-row">
                                ...
                                <div className="table-responsive">
                                  <table className="es-transaction  table">
                                    ...
                                    <tr>
                                      ...
                                      /></td>
                                      <td>{this.state.petValues.petBounty[0]}</td>
                                      <td>{this.state.petValues.monthlyTotalStaking[0]}</td>
                                    </tr>
                                    <tr>
                                      <td>Month 2 </td>
                                      <td><Form.Control
                                      ...
                                      /></td>
                                      <td>{this.state.petValues.petBounty[1]}</td>
                                      <td>{this.state.petValues.monthlyTotalStaking[1]}</td>
                                    </tr>
                                    <tr>
                                      <td>Month 3 </td>
                                      <td><Form.Control
                                      ...
                                      /></td>
                                      <td>{this.state.petValues.petBounty[2]}</td>
                                      <td>{this.state.petValues.monthlyTotalStaking[2]}</td>
                                    </tr>
                                    <tr>
                                      <td>Month 4 </td>
                                      <td><Form.Control
                                      ...
                                      /></td>
                                      <td>{this.state.petValues.petBounty[3]}</td>
                                      <td>{this.state.petValues.monthlyTotalStaking[3]}</td>
                                    </tr>
                                    ...
                                    <tr>
                                      ...
                                      /></td>
                                      <td>{this.state.petValues.petBounty[4]}</td>
                                      <td>{this.state.petValues.monthlyTotalStaking[4]}</td>
                                    </tr>
                                    <tr>
                                      <td>Month 6 </td>
                                      <td><Form.Control
                                      ...
                                      /></td>
                                      <td>{this.state.petValues.petBounty[5]}</td>
                                      <td>{this.state.petValues.monthlyTotalStaking[5]}</td>
                                    </tr>
                                    <tr>
                                      <td>Month 7 </td>
                                      <td><Form.Control
                                      ...
                                      /></td>
                                      <td>{this.state.petValues.petBounty[6]}</td>
                                      <td>{this.state.petValues.monthlyTotalStaking[6]}</td>
                                    </tr>
                                    <tr>
                                      <td>Month 8 </td>
                                      <td><Form.Control
                                      ...
                                      /></td>
                                      <td>{this.state.petValues.petBounty[7]}</td>
                                      <td>{this.state.petValues.monthlyTotalStaking[7]}</td>
                                    </tr>
                                    <tr>
                                      <td>Month 9 </td>
                                      <td><Form.Control
                                      ...
                                      /></td>
                                      <td>{this.state.petValues.petBounty[8]}</td>
                                      <td>{this.state.petValues.monthlyTotalStaking[8]}</td>
                                    </tr>
                                    <tr>
                                      <td>Month 10 </td>
                                      <td><Form.Control
                                      ...
                                      /></td>
                                      <td>{this.state.petValues.petBounty[9]}</td>
                                      <td>{this.state.petValues.monthlyTotalStaking[9]}</td>
                                    </tr>
                                    <tr>
                                      <td>Month 11 </td>
                                      <td><Form.Control
                                      ...
                                      /></td>
                                      <td>{this.state.petValues.petBounty[10]}</td>
                                      <td>{this.state.petValues.monthlyTotalStaking[10]}</td>
                                    </tr>
                                    <tr>
                                      <td>Month 12 </td>
                                      <td><Form.Control
                            ...
                            <div className="col-lg-12 text-right mt20">
                              <a className="btn btn-sm"
                                ...
                                onClick={this.calculateValues}>Calculate   </a>
                            </div>
                            <div className="col-lg-12 ">
                              <div className="mt30" >
                                <div className="card">
                                  ...
                                  <table className="es-transaction striped bordered hover">
                                    <thead>
                                      ...
                                      <tr>
                                        ...
                                        <td>{this.state.petValues.totalStaking}</td>
                                        <td>-</td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>{this.state.petValues.annuityBenifit}</td>
                                        <td>{this.state.petValues.annuityPercent}%</td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td><b>{this.state.petValues.grossBenifit}</b></td>
                                        <td><b>{this.state.petValues.grossBenifitPercent}%</b></td>
                                      </tr>
