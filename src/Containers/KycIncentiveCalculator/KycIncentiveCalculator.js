              ...
              <Row>
                ...
                <Col lg={6} className="text-right">
                  <a
                    ...
                    onClick={() =>
                      this.setState({
                        insentiveTable: !this.state.insentiveTable,
                      })
                    }
                  >
                    KYC Benifits{' '}
                      ...
                      <div className="row">
                          ...
                          <div class="form-row">
                            <div class="col-md-12 col-lg-12 form-group">
                              ...
                              <Form.Control
                                ...
                                autoComplete="off"
                                isInvalid={isNaN(
                                  Number(this.state.dayswappertreeInput)
                                )}
                              />
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6 form-group">
                              <label for="">
                                Level 2 KYC - Skill / Business (Directs)
                              </label>
                              <Form.Control
                                onChange={(event) =>
                                  this.setState({
                            ...
                            <div class="col-md-6 col-lg-6 form-group">
                              <label for="">
                                Level 3 KYC - Experience (Directs)
                              </label>
                              <Form.Control
                                onChange={(event) =>
                                  this.setState({
                                ...
                                isInvalid={isNaN(
                                  Number(
                                    this.state.directkycstandaloneInputThree
                                  )
                                )}
                              />
                            </div>
                            <div class="col-md-6 col-lg-6 form-group">
                              ...
                              <Form.Control
                                ...
                                isInvalid={isNaN(
                                  Number(
                                    this.state.directkycstandaloneInputFour
                                  )
                                )}
                              />
                            </div>
                            <div class="col-md-6 col-lg-6 form-group">
                              ...
                              <Form.Control
                                ...
                                isInvalid={isNaN(
                                  Number(
                                    this.state.directkycstandaloneInputFive
                                  )
                                )}
                              />
                            </div>
                        ...
                        <div className="col-lg-6">
                          <div class="form-row">
                            ...
                            <div class="col-md-12 col-lg-12">
                              <p className="text-weight">
                                <b>Cummulative KYC Input (Directs)</b>
                              </p>
                            </div>
                            <div class="col-md-6 col-lg-6 form-group">
                              <label for="">
