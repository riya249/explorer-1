                          ...
                          <div class="form-row mt20">
                            <div class="col-md-6 col-lg-6 form-group">
                              ...
                              <Form.Control
                                ...
                                autoComplete="off"
                                isInvalid={isNaN(
                                  Number(this.state.cAmountInput)
                                )}
                              />
                              <span>
                                {' '}
                                ...
                                <div className="table-responsive">
                                  <table className="es-transaction  table">
                                    <tr>
                                      ...
                                      <th>
                                        MONTHLY ANNUITY BENIFIT FOR 9 YEARS
                                      </th>
                                    </tr>
                                    <tr>
                                      <td>Month 1 </td>
                                  ...
                                  <table className="es-transaction striped bordered hover">
                                    <thead>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          {this.state.tsgapValues.totalStaking}
                                        </td>
                                        <td>-</td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          {this.state.tsgapValues.boosterBonus}
                                        </td>
                                        <td>
                                          {
                                            this.state.tsgapValues
