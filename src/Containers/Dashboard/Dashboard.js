            ...
            <Col lg={9}>
              <div className="sub-dashboard">
                <Col lg={3}>
                  ...
                  <h5 className="sub-dash-head">
                    {this.state.eraswap.data.esBTC} BTC
                  </h5>
                </Col>
                <Col lg={3}>
                ...
                <Col lg={3}>
                  <div className="sub-supply-box mb10">
                    <div className="es-box-ds">
                      ...
                      <p className="supply-txt">
                        {this.state.eraswap.data.totolESUsers} Users
                      </p>
                    </div>
                  </div>
                </Col>
                ...
                <Card>
                  <Card.Body>
                    ...
                    <p className="value-dash-txt">
                      {this.state.eraswap.data.btcUsd}
                    </p>
                  </Card.Body>
                </Card>
              </Col>
              <Col sm={6} lg={2} p-0>
                <Card>
                  <Card.Body>
                    ...
                    <p className="value-dash-txt">
                      {this.state.eraswap.data.ethUsd}
                    </p>
                  </Card.Body>
                </Card>
              </Col>
                ...
                <Col sm={6} lg={2} p-0>
                  <Card className="height-80 wd-120 ">
                    <Card.Body>
                      ...
                      <p className="value-dash-txt">
                        {this.state.eraswap.data.allTimeHigh}
                      </p>
                    </Card.Body>
                  </Card>
                </Col>
                <Col sm={6} lg={2} p-0>
                  <Card className="height-80 wd-120 ">
                    <Card.Body>
                      ...
                      <p className="value-dash-txt">
                        {this.state.eraswap.data.allTimeLow}
                      </p>
                    </Card.Body>
                  </Card>
                </Col>
