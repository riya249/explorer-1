      ...
      <div className="nrt-manager">
        <div className="booking-hero-bgd booking-hero-bgd-inner">
          ...
          <h2 className="es-main-head es-main-head-inner">
            Timeally Club Incentive Calculator
          </h2>
        </div>
                      ...
                      <div className="row">
                        <div className="col-lg-12">
                          <div class="form-row">
                            ...
                            <div class="col-md-6 col-lg-6 form-group">
                              <label for="">
                                Corresponding TimeAlly Club Belt
                              </label>
                              <input
                                placeholder=""
                                autocomplete="off"
                            ...
                            <div class="col-md-6 col-lg-6 form-group">
                              <label for="">Pet Staking (Direct Sale) </label>
                              <input
                                placeholder=""
                                autocomplete="off"
                                type="text"
                            ...
                            <div class="col-md-6 col-lg-6 form-group">
                              <label for="">TSGAP staking (Direct Sale)</label>
                              <input
                                placeholder=""
                                autocomplete="off"
                                type="text"
                            ...
                            <div class="col-md-6 col-lg-6 form-group">
                              <label for="">TA 1LT Staking (Direct Sale)</label>
                              <input
                                placeholder=""
                                autocomplete="off"
                                type="text"
                            ...
                            <div class="col-md-6 col-lg-6 form-group">
                              <label for="">Pet Staking (Indirect Sale)</label>
                              <input
                                placeholder=""
                                autocomplete="off"
                                type="text"
