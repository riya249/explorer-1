...
import './ContractsWithVerifiedSourceCodes.css';
...
class ContractsWithVerifiedSourceCodes extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
...
export default ContractsWithVerifiedSourceCodes;
