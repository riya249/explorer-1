...
export default class Apis {
                 ...
                 static fetchBlock = (blockNumber) =>
                   ajax(`${baseUrl}/block/${blockNumber}`);
                 static fetchAverageBlock = () =>
                   ajax(`${baseUrl}/block/average`);
                 ...
                 static fetchTransaction = (hash) =>
                   ajax(`${baseUrl}/transaction/${hash}`);
                 static fetchTransactionsByAddress = (address, limit = 25) =>
                   ajax(
                     `${baseUrl}/transaction/address/${address}?limit=${limit}`
                   );
                 ...
                 static luckPoolBal = () =>
                   ajax('https://eraswap.technology/nrt/luckPoolBal');
                 static burnTokenBal = () =>
                 ...
                 static getNumberOfStakings = () =>
                   ajax(
                     'https://eraswap.technology/timeally/getNumberOfStakings'
                   );
                 static getStakingPlanStatistics = () =>
                   ajax(
                     'https://eraswap.technology/timeally/getStakingPlanStatistics'
                   );
                 static getPlatformDetailsAllTime = () =>
                   ajax(
                     'https://eraswap.technology/timeally/getPlatformDetailsAllTime'
                   );
                 ...
                 static powerTokenDetails = () =>
                   ajax(
                     'https://eraswap.technology/swapperswall/powerTokenDetails'
                   );
                 static getTotalReward = () =>
                   ajax(
                     'https://eraswap.technology/dayswappers/getTotalReward'
                   );
                 ...
                 static transactionSplits = () =>
                   ajax(
                     'https://apis.dayswappers.com/userprofile/transaction_splits'
                   );
                 ...
                 static totalNoOfUser = () =>
                   ajax(
                     'https://apis.timeswappers.com/api/userDashboard/totalNoOfUser'
                   );
                 ...
                 static totalViewsOnProfile = () =>
                   ajax(
                     'https://apis.timeswappers.com/api/userDashboard/totalViewsOnProfile'
                   );
                 ...
                 static totalNoOfDeposit = () =>
                   ajax(
                     'https://apis.timeswappers.com/api/userDashboard/totalNoOfDeposit'
                   );
                 static totalNoOfWithdraw = () =>
                   ajax(
                     'https://apis.timeswappers.com/api/userDashboard/totalNoOfWithdraw'
                   );
                 static totalJobsPosted = () =>
                   ajax(
                     'https://apis.timeswappers.com/api/userDashboard/totalJobsPosted'
                   );
                 static totalJobsDone = () =>
                   ajax(
                     'https://apis.timeswappers.com/api/userDashboard/totalJobsDone'
                   );
                 static TfcGenerated = () =>
                   ajax(
                     'https://apis.timeswappers.com/api/userDashboard/TfcGenerated'
                   );
                 ...
                 static swapperswallTopTenreceivers = () =>
                   ajax(
                     'https://apis.timeswappers.com/api/tokensData/top-ten-receivers'
                   );

                 //eraswap.academy
                 static userscount = () =>
                   ajax('https://apis.eraswap.academy/api/userscount');
                 static courses = () =>
                   ajax('https://apis.eraswap.academy/api/courses');
                 static deposits = () =>
                   ajax('https://apis.eraswap.academy/api/deposits');
                 static userstudying = () =>
                 ...
                 static buzcafeTransactionscount = () =>
                   ajax(
                     'https://apis.buzcafe.com/api/fetch/transactions-count'
                   );
               }
